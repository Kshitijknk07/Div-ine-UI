  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute top-1/3 left-1/4 w-72 h-72 bg-[#00ADB5] rounded-full mix-blend-overlay filter blur-3xl opacity-20" />
        <div className="absolute top-1/4 right-1/4 w-72 h-72 bg-[#00ADB5] rounded-full mix-blend-overlay filter blur-3xl opacity-20" />
        <div className="absolute bottom-1/3 left-1/3 w-72 h-72 bg-[#00ADB5] rounded-full mix-blend-overlay filter blur-3xl opacity-20" />
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mt-16 max-w-7xl mx-auto px-4">
        {features.map((feature) => (
          <Card
            key={feature.name}
            className="bg-[#222831]/50 backdrop-blur-sm border-[#00ADB5]/20"
          >
            <CardContent className="p-6">
              <div className="flex items-center gap-4">
                <div className="p-2 rounded-lg bg-[#00ADB5]/10 text-[#00ADB5]">
                  {feature.icon}
                </div>
                <div>
